        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    blood_type = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    gsis_idno = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    gsis_polnno = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    pagibig_no = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    phic_no = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    sss_no = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    tin_no = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                    ...
                    sched = table.Column<int>(type: "int", nullable: false),
