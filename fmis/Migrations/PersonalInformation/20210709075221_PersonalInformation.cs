        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pagibig_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    phic_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    sss_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    tin_no = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
