    ...
    public partial class MyDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "300", "CO", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9825), "Capital Outlay", "06", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9826) },
                    { 2, "200", "MOOE", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9823), "Maintenance and Other Operating Expenses", "02", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9823) },
                    { 1, "100", "PS", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9815), "Personnel Services", "01", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(9819) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CURRENT", new DateTime(2022, 2, 17, 16, 12, 52, 846, DateTimeKind.Local).AddTicks(9255), new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(7850) },
                    { 2, "CONAP", new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(8179), new DateTime(2022, 2, 17, 16, 12, 52, 847, DateTimeKind.Local).AddTicks(8183) }
                });
