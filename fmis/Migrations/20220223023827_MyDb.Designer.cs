            ...
            modelBuilder.Entity("fmis.Models.Appropriation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 181, DateTimeKind.Local).AddTicks(9391),
                            UpdatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(8898)
                        },
                        new
                        {
                            AppropriationId = 2,
                            AppropriationSource = "CONAP",
                            CreatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(9213),
                            UpdatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(9218)
                        });
                });
            ...
            modelBuilder.Entity("fmis.Models.John.AllotmentClass", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Account_Code = "100",
                            Allotment_Class = "PS",
                            CreatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(761),
                            Desc = "Personnel Services",
                            Fund_Code = "01",
                            UpdatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(766)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            CreatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(769),
                            Desc = "Maintenance and Other Operating Expenses",
                            Fund_Code = "02",
                            UpdatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(770)
                        },
                        new
                        {
                            Id = 3,
                            Account_Code = "300",
                            Allotment_Class = "CO",
                            CreatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(772),
                            Desc = "Capital Outlay",
                            Fund_Code = "06",
                            UpdatedAt = new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(773)
                        });
                });
