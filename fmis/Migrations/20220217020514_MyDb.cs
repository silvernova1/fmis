    ...
    public partial class MyDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "300", "CO", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1452), "Capital Outlay", "06", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1453) },
                    { 2, "200", "MOOE", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1449), "Maintenance and Other Operating Expenses", "02", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1450) },
                    { 1, "100", "PS", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1441), "Personnel Services", "01", new DateTime(2022, 2, 17, 10, 5, 13, 698, DateTimeKind.Local).AddTicks(1445) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CURRENT", new DateTime(2022, 2, 17, 10, 5, 13, 696, DateTimeKind.Local).AddTicks(7876), new DateTime(2022, 2, 17, 10, 5, 13, 697, DateTimeKind.Local).AddTicks(9094) },
                    { 2, "CONAP", new DateTime(2022, 2, 17, 10, 5, 13, 697, DateTimeKind.Local).AddTicks(9430), new DateTime(2022, 2, 17, 10, 5, 13, 697, DateTimeKind.Local).AddTicks(9435) }
                });
