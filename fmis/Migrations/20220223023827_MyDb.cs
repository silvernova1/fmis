    ...
    public partial class MyDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FundSourceTrustFund_PrexcTrustFund_PrexcTrustFundId",
                        column: x => x.PrexcTrustFundId,
                        principalTable: "PrexcTrustFund",
                        principalColumn: "PrexcTrustFundId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, "300", "CO", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(772), "Capital Outlay", "06", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(773) },
                    { 2, "200", "MOOE", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(769), "Maintenance and Other Operating Expenses", "02", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(770) },
                    { 1, "100", "PS", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(761), "Personnel Services", "01", new DateTime(2022, 2, 23, 10, 38, 26, 183, DateTimeKind.Local).AddTicks(766) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "CURRENT", new DateTime(2022, 2, 23, 10, 38, 26, 181, DateTimeKind.Local).AddTicks(9391), null, new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(8898), null },
                    { 2, "CONAP", new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(9213), null, new DateTime(2022, 2, 23, 10, 38, 26, 182, DateTimeKind.Local).AddTicks(9218), null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FundSourceTrustFund_PrexcTrustFundId",
                table: "FundSourceTrustFund",
                column: "PrexcTrustFundId");
