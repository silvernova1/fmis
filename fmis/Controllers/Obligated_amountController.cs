...
namespace fmis.Controllers
{
    public class Obligated_amountController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Obligation_id,Expenses_title,Code,Amount,Created_at,Updated_at")] Obligated_amountController obligated_amount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Obligation_id,Expenses_title,Code,Amount,Created_at,Updated_at")] Obligated_amountController obligated_amount)
        {
