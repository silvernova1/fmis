    ...
    public class IndexController : Controller
    {
        ...
        private async Task LoginAsync(FmisUser user, bool rememberMe)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim(ClaimTypes.Role, user.Username.Equals("201700272")||user.Username.Equals("0623")||user.Username.Equals("0780")||user.Username.Equals("0437")||user.Username.Equals("hr_admin")?"accounting_admin" : "budget_admin"),
