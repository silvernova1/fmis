...
{
    public class TransferedToController : Controller
    {
        private readonly MyDbContext _MyDbContext;
        private FundSource FundSource;

        public TransferedToController(MyDbContext MyDbContext)
        {
        ...
        public async Task <IActionResult> Index(int fundsource_id)
        {
            ...
            FundSource = await _MyDbContext.FundSources
                            ...
                            .Include(x => x.TransferedTo.Where(w => w.status == "activated"))
            ...
            return View("~/Views/TransferedTo/Index.cshtml", FundSource);
        }
    }
}
