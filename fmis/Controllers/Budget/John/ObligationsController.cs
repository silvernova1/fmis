        ...
        public async Task<IActionResult> PrintOrs(string[] token)
        {
            using (MemoryStream stream = new System.IO.MemoryStream())
            {
                ...
                foreach (var i in token)
                {
                    ...
                    table2.AddCell(new PdfPCell(new Phrase("OBLIGATION REQUEST AND STATUS", times_new_roman_b12)) { Padding = 6f, Border = 0, HorizontalAlignment = Element.ALIGN_CENTER });
                    ...
                    if (allotmentsAA.FirstOrDefault()?.sub_allotment == 1 && allotmentsAA.FirstOrDefault().obligation == "sub_allotment")
                    {
                        ...
                        table3.AddCell(new PdfPCell(new Paragraph("Date :", times_new_roman_r8)) { Padding = 6f, Border = 0 });
                        table3.AddCell(new PdfPCell(new Paragraph(ors.Date.ToShortDateString(), times_new_roman_r8)) { Border = 2, Padding = 6f, HorizontalAlignment = Element.ALIGN_CENTER, PaddingRight = 5 });

                        table3.AddCell(new PdfPCell(new Paragraph("Fund Cluster :", times_new_roman_r8)) { Padding = 6f, Border = 0 });
                        table3.AddCell(new PdfPCell(new Paragraph(allotmentsAA.FirstOrDefault().allotment + "-" + allotmentsAA.FirstOrDefault().fundCurrent, times_new_roman_r8)) { Border = 2, Padding = 6f, HorizontalAlignment = Element.ALIGN_CENTER, PaddingRight = 5 });
                    ...
                    if (allotments.FirstOrDefault()?.fundsource == 2 && allotments.FirstOrDefault()?.obligation == "fund_source")
                    {
                        ...
                        table3.AddCell(new PdfPCell(new Paragraph("Serial No.", times_new_roman_r8)) { Padding = 6f, Border = 0 });
                        table3.AddCell(new PdfPCell(new Paragraph(allotments.FirstOrDefault()?.allotment + "-" + allotments.FirstOrDefault()?.fundConap + "-" + ors.Date.ToString("yyyy-MM") + "-" + "000" + ors.Id, times_new_roman_r8)) { Border = 2, Padding = 6f, HorizontalAlignment = Element.ALIGN_CENTER, PaddingRight = 5 });

                        table3.AddCell(new PdfPCell(new Paragraph("Date: ", times_new_roman_r8)) { Padding = 6f, Border = 0 });
                        table3.AddCell(new PdfPCell(new Paragraph(ors.Date.ToShortDateString(), times_new_roman_r8)) { Border = 2, Padding = 6f, HorizontalAlignment = Element.ALIGN_CENTER, PaddingRight = 5 });

                        table3.AddCell(new PdfPCell(new Paragraph("Fund Cluster :", times_new_roman_r8)) { Padding = 6f, Border = 0 });
                        table3.AddCell(new PdfPCell(new Paragraph(allotments.FirstOrDefault()?.allotment + "-" + allotments.FirstOrDefault()?.fundConap, times_new_roman_r8)) { Border = 2, Padding = 6f, HorizontalAlignment = Element.ALIGN_CENTER, PaddingRight = 5 });
                    ...
                    table_row_2.AddCell(new PdfPCell(new Paragraph("Payee", times_new_roman_r9)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    table_row_2.AddCell(new PdfPCell(new Paragraph(ors.Payee, times_new_roman_b9)));
                    ...
                    table_row_3.AddCell(new PdfPCell(new Paragraph("Office", times_new_roman_r9)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    table_row_3.AddCell(new PdfPCell(new Paragraph("", times_new_roman_b9)));
                    ...
                    table_row_5.AddCell(new PdfPCell(new Paragraph("Responsibility Center", times_new_roman_b8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 25, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_5.AddCell(new PdfPCell(new Paragraph("Particulars", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_5.AddCell(new PdfPCell(new Paragraph("MFO/PAP", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_5.AddCell(new PdfPCell(new Paragraph("UACS Object Code", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_5.AddCell(new PdfPCell(new Paragraph("Amount", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    tbt_total_amt.AddCell(new PdfPCell(new Paragraph(total_amt.ToString("C", new CultureInfo("en-PH")), times_new_roman_r9)) { HorizontalAlignment = Element.ALIGN_RIGHT });
                    ...
                    table_row_8.AddCell(new PdfPCell(new Paragraph("A.", times_new_roman_r9)));
                    table_row_8.AddCell(new PdfPCell(new Paragraph("Certified:", times_new_roman_b8)));
                    table_row_8.AddCell(new PdfPCell(new Paragraph("B.", times_new_roman_r9)));
                    table_row_8.AddCell(new PdfPCell(new Paragraph("Certified:", times_new_roman_b8)));
                    ...
                    if (allotments.FirstOrDefault()?.obligation == "fund_source")
                    {
                        ...
                        //HEAD REQUESTING OFFICE / AUTHORIZED REPRESENTATIVE
                        table_row_8.AddCell(new PdfPCell(new Paragraph(fundsources.FirstOrDefault()?.position, times_new_roman_r7)) { HorizontalAlignment = Element.ALIGN_CENTER });
                        table_row_8.AddCell(new PdfPCell(new Paragraph("Position:", times_new_roman_r8)));
...
/*
                        ...
                        table_row_8.AddCell(new PdfPCell(new Paragraph("Date:", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                        table_row_8.AddCell(new PdfPCell(new Paragraph(ors.Date.ToString("MM/dd/yyyy"), times_new_roman_b8)) { HorizontalAlignment = Element.ALIGN_CENTER, VerticalAlignment = Element.ALIGN_MIDDLE });
                        doc.Add(table_row_8);
                    }
                    else
                    {
                        ...
                        table_row_8.AddCell(new PdfPCell(new Paragraph("Position :", times_new_roman_r8)));
                        //HEAD REQUESTING OFFICE / AUTHORIZED REPRESENTATIVE
                        table_row_8.AddCell(new PdfPCell(new Paragraph(saasignatory.FirstOrDefault()?.respoPosition, times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER });
                        table_row_8.AddCell(new PdfPCell(new Paragraph("Position", times_new_roman_r8)));
                        table_row_8.AddCell(new PdfPCell(new Paragraph("BUDGET OFFICER III", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER });
                        ...
                        table_row_8.AddCell(new PdfPCell(new Paragraph("", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 20f });
                        table_row_8.AddCell(new PdfPCell(new Paragraph("Date: ", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_LEFT, VerticalAlignment = Element.ALIGN_MIDDLE });
                        table_row_8.AddCell(new PdfPCell(new Paragraph(ors.Date.ToString("MM/dd/yyyy"), times_new_roman_b8)) { HorizontalAlignment = Element.ALIGN_CENTER });
                        doc.Add(table_row_8);
                    }
                    ...
                    table_row_10.AddCell(new PdfPCell(new Paragraph("Reference", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    table_row_10.AddCell(new PdfPCell(new Paragraph("Amount", times_new_roman_b9)) { HorizontalAlignment = Element.ALIGN_CENTER });
                    ...
                    table_row_11.AddCell(new PdfPCell(new Paragraph("Date", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_11.AddCell(new PdfPCell(new Paragraph("Particulars", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    table_row_11.AddCell(new PdfPCell(new Paragraph("ORS/JEV/RCI/RADAI No.", times_new_roman_r7)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    obli.AddCell(new PdfPCell(new Paragraph("Obligation", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    obli.AddCell(new PdfPCell(new Paragraph("(a)", times_new_roman_r8)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER });
                    ...
                    paya.AddCell(new PdfPCell(new Paragraph("Payable", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    paya.AddCell(new PdfPCell(new Paragraph("(b)", times_new_roman_r8)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER });
                    ...
                    paye.AddCell(new PdfPCell(new Paragraph("Payment", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 35, VerticalAlignment = Element.ALIGN_MIDDLE });
                    paye.AddCell(new PdfPCell(new Paragraph("(c)", times_new_roman_r8)) { Border = 0, HorizontalAlignment = Element.ALIGN_CENTER });
                    ...
                    blnc.AddCell(new PdfPCell(new Paragraph("Balance", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 25, VerticalAlignment = Element.ALIGN_MIDDLE });

                    PdfPTable due = new PdfPTable(2);
                    float[] due_width = { 10, 10 };
                    due.WidthPercentage = 100f;
                    due.SetWidths(due_width);
                    due.AddCell(new PdfPCell(new Paragraph("Not Yet Due and Demandable", times_new_roman_r7)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 20, VerticalAlignment = Element.ALIGN_MIDDLE });
                    due.AddCell(new PdfPCell(new Paragraph("Due and Demandable", times_new_roman_r7)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 20, VerticalAlignment = Element.ALIGN_MIDDLE });
                    ...
                    duedate.AddCell(new PdfPCell(new Paragraph("(a-b)", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 10, VerticalAlignment = Element.ALIGN_MIDDLE });
                    duedate.AddCell(new PdfPCell(new Paragraph("(b-c)", times_new_roman_r8)) { HorizontalAlignment = Element.ALIGN_CENTER, FixedHeight = 10, VerticalAlignment = Element.ALIGN_MIDDLE });
