    ...
    public class Sub_allotmentController : Controller
    {
        ...
        public IActionResult Create(int? id)
        {
            var json = JsonSerializer.Serialize(_MyDbContext.Suballotment_amount
                .Where(f => f.Sub_allotment.Id == id).ToList());
            ViewBag.temp = json;
        ...
        public async Task<IActionResult> Create([Bind("Id,Prexe_code,Suballotment_code,Suballotment_title,Ors_head,Responsibility_number,Description,Budget_allotmentBudgetAllotmentId,Id")] Sub_allotment sub_allotment)
        {
            try
            {
